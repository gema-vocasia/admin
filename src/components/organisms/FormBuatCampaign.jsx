...
import {FormField, FileUploadField, DateField} from "../molecules";
import { Select, Button, Label } from "../atoms";
  ...
  return (
    <div className="flex items-center justify-center p-6 bg-gray-100">
      <div className="w-full max-w-3xl p-8 m-8 overflow-hidden bg-white rounded-lg shadow-xl">
        {currentStep === 0 && (
          <div
            className="p-8 m-8 bg-white border-t-4"
            style={{ borderColor: "#5E84C5" }}
          >
            <h2
